...
const user = ref({
  ...
  email: "",
  phone: "",
  profileImage: "https://i.pinimg.com/236x/14/6d/e1/146de169d3133554a6d907b837d31377.jpg",
});
  ...
  if (storedUser && storedUser.id) {
    try {
      ...
      if (response.data) {
        ...
        user.value.profileImage = response.data.profileImage || user.value.profileImage;
      } else {
